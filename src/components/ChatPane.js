...
function ChatPane(props) {
  ...
  return (
    <div style={ChatPaneStyle.pane}>
      <div style={ChatPaneStyle.header}>
        <h2 style={ChatPaneStyle.headerH2}>{currentChannelName}</h2>
        <button style={ChatPaneStyle.editButton}>✎</button>
      </div>
